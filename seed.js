...
const actors = [
    {
        ...
        country: "US",
        oscars: 1,
        famous_for: ["Inception", "Titanic", "The Revenant"]
    },
    {
        name: "Morgan Freeman",
        birth_year: 1937,
        country: "US",
        oscars: 1,
        famous_for: ["The Shawshank Redemption", "Se7en"]
    },
    {
        name: "Keanu Reeves",
        birth_year: 1964,
        country: "CA",
        oscars: 0,
        famous_for: ["The Matrix", "John Wick"]
    },
    {
        name: "Tom Hanks",
        birth_year: 1956,
        country: "US",
        oscars: 2,
        famous_for: ["Forrest Gump", "Cast Away"]
    },
    {
        name: "Brad Pitt",
        birth_year: 1963,
    ...
    },
    {
        ...
        country: "UK",
        oscars: 2,
        famous_for: ["The Silence of the Lambs"]
    },
    {
        name: "Jodie Foster",
        birth_year: 1962,
        country: "US",
        oscars: 2,
        famous_for: ["Contact", "The Silence of the Lambs"]
    },
    {
        name: "Anne Hathaway",
        birth_year: 1982,
        country: "US",
        oscars: 1,
        famous_for: ["Interstellar", "Les Misérables"]
    },
    {
        name: "Michelle Yeoh",
        birth_year: 1962,
        country: "MY",
        oscars: 1,
        famous_for: ["Everything Everywhere All at Once"]
    },
    {
        name: "Javier Bardem",
        birth_year: 1969,
        country: "ES",
        oscars: 1,
        famous_for: ["No Country for Old Men"]
    }
];
...
const users = [
    ...
    { username: "retroviewer", email: "retro@example.com", country: "MX", subscription: "basic", registered_at: new Date("2024-01-10") },
    { username: "animefan_x", email: "anime@example.com", country: "JP", subscription: "premium", registered_at: new Date("2023-11-02") },
    { username: "cine_latam", email: "latam@example.com", country: "PE", subscription: "basic", registered_at: new Date("2022-08-18") },
    { username: "thriller_addict", email: "thriller@example.com", country: "US", subscription: "premium", registered_at: new Date("2024-03-14") },
    { username: "classicfilms", email: "classic@example.com", country: "IT", subscription: "premium", registered_at: new Date("2021-05-22") }
];
...
async function seed() {
    ...
    try {
        ...
        await db.collection("actors").drop().catch(() => {});
        ...
        // Insert actors
        const actorsResult = await db.collection("actors").insertMany(actors);
        const actorIds = Object.values(actorsResult.insertedIds);
        console.log(`🎭 ${actorIds.length} actores insertados`);
        ...
        await db.collection("actors").createIndex({ name: "text" });
